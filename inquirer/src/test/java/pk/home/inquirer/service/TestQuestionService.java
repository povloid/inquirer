...
/**
 * JUnit test service class for entity class: Question
 * Question - вопрос
 */
...
public class TestQuestionService {
	 ...
	 */
	@Autowired
	public void setDataStore(QuestionService service) {
	...
	public void testGetAllEntities() throws Exception {
		...
		for (int i = 0; i < 100; i++) {
			...
			service.persist(question);
			index++;
		}

		List<Question> list = service.getAllEntities();
	...
	public void testGetAllEntitiesSingularAttributeOfTQSortOrderType()
		...
		List<Question> list = service.getAllEntities(Question_.id, SortOrderType.ASC);
	...
	public void testGetAllEntitiesIntInt() throws Exception {
		...
		List<Question> list = service.getAllEntities(10, 10);
	...
	public void testGetAllEntitiesIntIntSingularAttributeOfTQSortOrderType()
		...
		List<Question> list = service.getAllEntities(10, 10, Question_.id,
				SortOrderType.ASC);
	...
	public void testGetAllEntitiesBooleanIntIntSingularAttributeOfTQSortOrderType()
		...
		// all - FALSE
		List<Question> list = service.getAllEntities(false, 10, 10, Question_.id,
				SortOrderType.ASC);
		...
		// all - TRUE
		list = service.getAllEntities(true, 10, 10, Question_.id,
				SortOrderType.ASC);
	...
	public void testFind() throws Exception {
		...
		question = service.persist(question);

		long id = question.getId();

		Question question2 = service.find(id);
	...
	public void testRefresh() throws Exception {
		...
		question2 = service.refresh(question2);
	...
	public void testMerge() throws Exception {
		...
		question2.setKeyName("key 65535");
		question2 = service.merge(question2);

		question = service.refresh(question);
	...
	public void testRemove() throws Exception {
		...
		Question question3 = service.find(id);
